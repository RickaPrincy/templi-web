...
import { Github, Link as LinkIcon, FileText, FolderTree, Info } from "lucide-react";
        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
            {templates.map((template) => (
              <Card key={template.name} className="transition-all duration-300 hover:shadow-md flex flex-col">
                <CardHeader>

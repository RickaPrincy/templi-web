...
// Using the template type from the Boilerplates page
type Template = {
  id: string;
  name: string;
  description: string;
...
const BoilerplateDetails = () => {
  ...
  useEffect(() => {
    ...
    if (foundTemplate) {
      ...
      // Redirect to boilerplates page if template not found
              ...
              <CardContent className="pt-6">
                <ol className="list-decimal pl-5 space-y-4">
                  <li>
                    ...
                    <p>Before using this template, make sure you have Templi installed.</p>
                  </li>
                  <li>
